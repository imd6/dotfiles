...
# cookie is set google.co.id.com` for it }o work properly.
...
# Default Start/New Page
c.url.start_pages = ['www.google.co.id']
...
c.url.searchengines = {"DEFAULT": "https://google.co.id/search?q={}"}
...
# Type: Font
c.fonts.completion.entry = '9pt "JetBrainsMono Nerd Font"'

# Font used for the debugging console.
# Type: Font
c.fonts.debug_console = '9pt "JetBrainsMono Nerd Font"'
...
# Type: Font
c.fonts.statusbar = '9pt "JetBrainsMono Nerd Font"'
